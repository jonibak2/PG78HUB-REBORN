...
### ⚡ Быстро на Render.com (рекомендуется для начинающих)
...
4. Добавьте VAPID ключи в переменные окружения
5. Нажмите Deploy!

**Преимущества:**
- ✅ Бесплатный tier (с限制 во времени активности)
- ✅ Автоматические деплойи из GitHub
- ✅ HTTPS по умолчанию
- ✅ Всё настроено за 5 минут
- ✅ Не нужно управлять серверо м

**Подробный гайд:** [RENDER_DEPLOYMENT.md](RENDER_DEPLOYMENT.md)

---

### 🖥️ На VPS (для production с 24/7 uptime)
